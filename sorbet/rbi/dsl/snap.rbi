...
# This is an autogenerated file for dynamic methods in `Snap`.
# Please instead update this file by running `bin/tapioca dsl Snap`.
...
class Snap
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Snap).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Snap).void)).returns(::Snap) }
    ...
    sig { returns(T::Array[::Snap]) }
    def destroy_all; end

    sig { params(conditions: T.untyped).returns(T::Boolean) }
    def exists?(conditions = :none); end

    sig { returns(T.nilable(::Snap)) }
    def fifth; end
    ...
    sig { params(args: T.untyped).returns(T.nilable(::Snap)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::Snap) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::Snap).void)
      ).returns(T.nilable(T::Enumerator[::Snap]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::Snap]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::Snap]]))
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::Snap)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::Snap) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::Snap) }
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T::Boolean) }
    def processed_at_previously_changed?; end
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Snap, T::Enumerable[T.any(::Snap, T::Enumerable[::Snap])])
    ...
    sig do
      params(
        records: T.any(::Snap, Integer, String, T::Enumerable[T.any(::Snap, Integer, String, T::Enumerable[::Snap])])
      ).returns(T::Array[::Snap])
    end
    ...
    sig do
      params(
        other_array: T.any(::Snap, T::Enumerable[T.any(::Snap, T::Enumerable[::Snap])])
      ).returns(T::Array[::Snap])
    end
