...
export type BookKeySpecifier = ('authorName' | 'id' | 'title' | BookKeySpecifier)[];
...
export type UserKeySpecifier = ('avatarUrl' | 'email' | 'firstName' | 'id' | 'initials' | 'isAdmin' | 'lastName' | 'name' | UserKeySpecifier)[];
